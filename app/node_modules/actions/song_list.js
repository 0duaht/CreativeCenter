...
export function fetchNewSongs(requestType){
  return dispatch => {
    dispatch(requestNewSongs());
    return songService.getNewSongs(requestType, (response, status) => {
...
export function fetchAllNewSongs(){
  return dispatch => {
    ...
    return songService.getAllNewSongs(requestType, (response, status) => {
      if (status === undefined || status != 200){
...
export function fetchPopularSongs(requestType){
  return dispatch => {
    dispatch(requestPopularSongs());
    return songService.getPopularSongs(requestType, (response, status) => {
      if (status === undefined || status != 200){
...
export function fetchAllPopularSongs(){
  return dispatch => {
    ...
    return songService.getAllPopularSongs(requestType, (response, status) => {
      if (status === undefined || status != 200){
